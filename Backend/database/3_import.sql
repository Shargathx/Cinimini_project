...
VALUES (default, 'Heli', 'See mäng on heli baasil', true);
INSERT INTO public.category (id, name, description, is_active)
VALUES (default, 'Video', 'See mäng on video baasil', true);
INSERT INTO public.category (id, name, description, is_active)
...
INSERT INTO public.game (id, name, category_id, description, is_active)
VALUES (default, 'Mida näed pildilt?', 2,
        'Mida see video sind tundma paneb? Kas sinu emotsiooni mõjutab fakt, et video on värvitu/värviline?', true);
INSERT INTO public.game (id, name, category_id, description, is_active)
VALUES (default, 'Mida näed pildilt?', 3,
        'Mida see heli sind tundma paneb? Kas sinu emotsiooni mõjutab fakt, et heli on efektiga/ilma?', true);
INSERT INTO public.game (id, name, category_id, description, is_active)
VALUES (default, 'Mida näed anomaalialt?', 1, 'Mitteaktiivne mäng, testimiseks', false);


INSERT INTO public.game_step (id, game_id, step_order)
VALUES (default, 1, 1);
INSERT INTO public.game_step (id, game_id, step_order)
VALUES (default, 2, 1);
INSERT INTO public.game_step (id, game_id, step_order)
...
INSERT INTO public.question(id, game_step_id, question_text, is_active, question_order)
VALUES (default, 1, 'Kes on pildil?', true, 2);
INSERT INTO public.question(id, game_step_id, question_text, is_active, question_order)
